...
app.post('/add',function(req,res){
  var record = new schema1 ({ id:req.body.id ,title:req.body.title , release_date:req.body.date, popularity: req.body.popularity,
  overview:req.body.overview,vote_count:req.body.vote_count,vote_average:req.body.vote_average,poster_path:req.body.poster_path 
})
